...
public class InvalidateCacheActivity extends Activity {
    ...
    private void loadFromServer(final Boolean noCache){
        if(!noCache){
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET, URL, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            txtEmail.setText(response.getString("email"));
                            if(!noCache){
                                Toast.makeText(InvalidateCacheActivity.this, "Update cache successfully", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            Toast.makeText(InvalidateCacheActivity.this, "Error JSON parsing", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        pDialog.hide();
                        // show toast
                        Toast.makeText(InvalidateCacheActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
        );
